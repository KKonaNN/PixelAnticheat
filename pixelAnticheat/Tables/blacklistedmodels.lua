...
PIXEL_E.AntiNukeBlacklistedObjects = { 
"prop_rock_1_a",
"prop_rock_1_b",
"prop_rock_1_c",
"prop_rock_1_d",
...
PIXEL_E.AntiNukeBlacklistedVehicles = { -- Models/Vehicles/Airplanes etc etc.
...
{name = "terbyte",    ban = false , log = true},
...
PIXEL_E.AntiNukeBlacklistedPeds = { -- Peds, animals, etc.
...
{name = "a_c_sharktiger", ban = true , log = true},
...
{name = "a_m_o_acult_02", ban = false , log = true},
{name = "a_m_y_acult_02", ban = false , log = true},
}